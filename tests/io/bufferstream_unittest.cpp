...
//test input stream
TEST(BufferStreamTest, InputStreamLE) {
	...
	BufferStream* bs = new BufferStream(buffer);

	BinaryReader* ins = new BinaryReader(bs);
...
TEST(BufferStreamTest, InputStreamBE) {
...
TEST(BufferStreamTest, OutputStreamLE) {
	...
	BufferStream* bs = new BufferStream(buffer);
	BinaryWriter* outs = new BinaryWriter(bs);
...
TEST(BufferStreamTest, OutputStreamBE) {
